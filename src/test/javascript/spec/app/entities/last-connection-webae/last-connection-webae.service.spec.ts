...
describe('Service Tests', () => {
    ...
    describe('LastConnectionWebae Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LastConnectionWebaeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/last-connections';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LastConnectionWebae', () => {
