...
describe('Service Tests', () => {
    ...
    describe('UserDeviceWebae Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UserDeviceWebaeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-devices';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UserDeviceWebae', () => {
