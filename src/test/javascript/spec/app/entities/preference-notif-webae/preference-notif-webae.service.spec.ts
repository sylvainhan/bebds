...
describe('Service Tests', () => {
    ...
    describe('PreferenceNotifWebae Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PreferenceNotifWebaeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/preference-notifs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PreferenceNotifWebae', () => {
